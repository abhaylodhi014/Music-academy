...
function Herosection() {
  return (
    <div className='h-auto  md:h-[40rem]  w-full rounded-md flex flex-col item-center justify-center relative overflow-hidden mx-auto py-10 md:py-0  '>
      ...
      >Dive into our comprehensice music courses and transform your musical journey today. whether you're a vefinnner or looking to refine your skills , join us to unlock your true potentials .</p>
